            ...
            <li>
              <figure className="relative rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-xl shadow-slate-900/10 dark:shadow-gray-800/50">
                ...
                <blockquote className="relative">
                  <p className="text-lg tracking-tight text-slate-900 dark:text-slate-200">I love the programming pathsala mentors how they teach concepts in depth and it help in my interviews</p>
                </blockquote>
          ...
          <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
            <li>
              <figure className="relative rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-xl shadow-slate-900/10 dark:shadow-gray-800/50">
                ...
                <blockquote className="relative">
                  <p className="text-lg tracking-tight text-slate-900 dark:text-slate-200">Lorem ipsum dolor sit amet consectetur adipiscing elit, et donec gravida libero cursus laoreet.</p>
                </blockquote>
                <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 dark:border-slate-700 pt-6">
                  <div>
